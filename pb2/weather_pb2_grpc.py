...
from pb2 import weather_pb2 as weather__pb2
...
class WeatherServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetWeather = channel.stream_stream(
...
def add_WeatherServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetWeather': grpc.stream_stream_rpc_method_handler(
                    servicer.GetWeather,
...
class WeatherService(object):
    ...
    @staticmethod
    def GetWeather(request_iterator,
            target,
            options=(),
